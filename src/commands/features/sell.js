...
module.exports = {
	data: new SlashCommandBuilder()
		.setName('sell')
		.setDescription('Create a new sell order.')
        .addStringOption(
            option => option.setName('item_name').setDescription('The item to sell').setRequired(true)
...
async function handleSellCommand(interaction) {
    ...
    const responseMessage = `Selling ${resolvedItem.name} at Quality ${quality} for ${quantity} units at ${finalPrice}`;
